---
name: plugin-api-standalone.index
description: Use when executing plugin api standalone.index protocols within the production sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core plugin api standalone.index logic directly into the active system context.
