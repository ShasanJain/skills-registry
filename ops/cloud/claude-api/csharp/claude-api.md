---
name: claude-api
description: Use when executing claude api protocols within the ops sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core claude api logic directly into the active system context.
