---
name: models
description: Use when executing models protocols within the ops sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core models logic directly into the active system context.
