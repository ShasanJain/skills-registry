---
name: forgettable-results
description: Use when executing forgettable results protocols within the design sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core forgettable results logic directly into the active system context.
