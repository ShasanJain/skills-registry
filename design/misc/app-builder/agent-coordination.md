...
description: Use when executing agent coordination protocols within the design sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core agent coordination logic directly into the active system context.
