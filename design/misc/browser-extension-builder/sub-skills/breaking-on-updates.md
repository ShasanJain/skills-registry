---
name: breaking-on-updates
description: Use when executing breaking on updates protocols within the design sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core breaking on updates logic directly into the active system context.
