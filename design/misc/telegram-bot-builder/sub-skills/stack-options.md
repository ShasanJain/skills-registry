---
name: stack-options
description: Use when executing stack options protocols within the design sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core stack options logic directly into the active system context.
