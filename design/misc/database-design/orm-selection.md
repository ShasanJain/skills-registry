---
name: orm-selection
description: Use when executing orm selection protocols within the design sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core orm selection logic directly into the active system context.
