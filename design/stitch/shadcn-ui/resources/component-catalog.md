...
description: Use when executing component catalog protocols within the design sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core component catalog logic directly into the active system context.
