---
name: advanced-patterns-architectures
description: Use when applying advanced patterns architectures patterns to optimize agent workflows.
---

# Advanced Patterns Architectures: Standard Operating Procedure

## ⚙️ Overview
This protocol defines the strict standard for implementing Advanced Patterns Architectures. By following this SOP, the engine ensures token efficiency, maximum architectural stability, robust caching, and adherence to all operational guardrails established by the system architecture.
