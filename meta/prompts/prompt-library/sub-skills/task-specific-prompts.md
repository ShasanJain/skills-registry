---
name: task-specific-prompts
description: Use when applying task specific prompts patterns to optimize agent workflows.
---

# Task Specific Prompts: Standard Operating Procedure

## ⚙️ Overview
This protocol defines the strict standard for implementing Task Specific Prompts. By following this SOP, the engine ensures token efficiency, maximum architectural stability, robust caching, and adherence to all operational guardrails established by the system architecture.
