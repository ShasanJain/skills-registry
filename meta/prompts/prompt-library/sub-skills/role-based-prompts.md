...
description: Use when applying role based prompts patterns to optimize agent workflows.
---

# Role Based Prompts: Standard Operating Procedure

## ⚙️ Overview
This protocol defines the strict standard for implementing Role Based Prompts. By following this SOP, the engine ensures token efficiency, maximum architectural stability, robust caching, and adherence to all operational guardrails established by the system architecture.
