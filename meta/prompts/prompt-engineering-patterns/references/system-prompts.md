---
name: system-prompts
description: Use when applying system prompts patterns to optimize agent workflows.
---

# System Prompts: Standard Operating Procedure

## ⚙️ Overview
This protocol defines the strict standard for implementing System Prompts. By following this SOP, the engine ensures token efficiency, maximum architectural stability, robust caching, and adherence to all operational guardrails established by the system architecture.
