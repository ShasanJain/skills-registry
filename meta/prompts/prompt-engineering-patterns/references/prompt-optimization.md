...
description: Use when applying prompt optimization patterns to optimize agent workflows.
---

# Prompt Optimization: Standard Operating Procedure

## ⚙️ Overview
This protocol defines the strict standard for implementing Prompt Optimization. By following this SOP, the engine ensures token efficiency, maximum architectural stability, robust caching, and adherence to all operational guardrails established by the system architecture.
