...
description: Use when applying prompt template library patterns to optimize agent workflows.
---

# Prompt Template Library: Standard Operating Procedure

## ⚙️ Overview
This protocol defines the strict standard for implementing Prompt Template Library. By following this SOP, the engine ensures token efficiency, maximum architectural stability, robust caching, and adherence to all operational guardrails established by the system architecture.
