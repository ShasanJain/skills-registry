---
name: css-recipes
description: Use when executing css recipes protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core css recipes logic directly into the active system context.
