...
description: Use when executing sms sending pattern protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core sms sending pattern logic directly into the active system context.
