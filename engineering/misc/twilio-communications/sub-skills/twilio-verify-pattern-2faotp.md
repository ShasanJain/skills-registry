---
name: twilio-verify-pattern-2faotp
description: Use when executing twilio verify pattern 2faotp protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core twilio verify pattern 2faotp logic directly into the active system context.
