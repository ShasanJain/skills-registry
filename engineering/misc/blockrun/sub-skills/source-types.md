---
name: source-types
description: Use when executing source types protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core source types logic directly into the active system context.
