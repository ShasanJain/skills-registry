---
name: common-problems-fixes
description: Use when executing common problems fixes protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core common problems fixes logic directly into the active system context.
