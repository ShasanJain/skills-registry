---
name: s2-theme
description: Use when executing s2 theme protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core s2 theme logic directly into the active system context.
