---
name: s2-event
description: Use when executing s2 event protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core s2 event logic directly into the active system context.
