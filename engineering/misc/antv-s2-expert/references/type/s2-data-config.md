---
name: s2-data-config
description: Use when executing s2 data config protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core s2 data config logic directly into the active system context.
