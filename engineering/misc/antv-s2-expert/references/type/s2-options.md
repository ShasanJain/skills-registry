---
name: s2-options
description: Use when executing s2 options protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core s2 options logic directly into the active system context.
