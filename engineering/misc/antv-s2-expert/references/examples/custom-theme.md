---
name: custom-theme
description: Use when executing custom theme protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core custom theme logic directly into the active system context.
