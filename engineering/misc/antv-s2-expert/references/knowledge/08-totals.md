---
name: 08-totals
description: Use when executing 08 totals protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 08 totals logic directly into the active system context.
