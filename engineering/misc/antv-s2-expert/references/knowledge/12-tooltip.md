---
name: 12-tooltip
description: Use when executing 12 tooltip protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 12 tooltip logic directly into the active system context.
