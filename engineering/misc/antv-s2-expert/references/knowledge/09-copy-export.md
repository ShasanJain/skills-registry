---
name: 09-copy-export
description: Use when executing 09 copy export protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 09 copy export logic directly into the active system context.
