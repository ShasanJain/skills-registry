---
name: 01-sheet-types
description: Use when executing 01 sheet types protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 01 sheet types logic directly into the active system context.
