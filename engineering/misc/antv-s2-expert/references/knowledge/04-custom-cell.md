---
name: 04-custom-cell
description: Use when executing 04 custom cell protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 04 custom cell logic directly into the active system context.
