---
name: 16-react-components
description: Use when executing 16 react components protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 16 react components logic directly into the active system context.
