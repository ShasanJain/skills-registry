---
name: 07-sort
description: Use when executing 07 sort protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 07 sort logic directly into the active system context.
