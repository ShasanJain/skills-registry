---
name: what-happened
description: Use when executing what happened protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core what happened logic directly into the active system context.
