...
description: Use when executing perception reasoning action loop protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core perception reasoning action loop logic directly into the active system context.
