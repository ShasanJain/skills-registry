...
description: Use when executing voice over script protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core voice over script logic directly into the active system context.
