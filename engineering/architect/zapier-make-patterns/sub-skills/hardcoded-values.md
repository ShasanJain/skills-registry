...
description: Use when executing hardcoded values protocols within the engineering sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core hardcoded values logic directly into the active system context.
