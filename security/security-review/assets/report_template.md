...
description: Use when executing report_template protocols within the security sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core report_template logic directly into the active system context.
