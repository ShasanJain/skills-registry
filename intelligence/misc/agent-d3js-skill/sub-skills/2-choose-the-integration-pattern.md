---
name: 2-choose-the-integration-pattern
description: Use when executing 2 choose the integration pattern protocols within the intelligence sector.
---
...
- **Step 2: Apply the Pattern**: Implement the core 2 choose the integration pattern logic directly into the active system context.
